...
SCHEMA_PATH = Path('C:/Users/Dell/Desktop/assignment03/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\Dell\\Desktop\\assignment03\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    record: 'actions.RecordActions[models.Record]'
    ...
    def __init__(
        ...
        *,
        ...
        self.record = actions.RecordActions[models.Record](self, models.Record)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Dell/Desktop/assignment03/prisma/schema.prisma',
        }
...
class Batch:
    record: 'RecordBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.record = RecordBatchActions(self)
...
class RecordBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.RecordCreateInput,
        include: Optional[types.RecordInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Record,
    ...
    def create_many(
        self,
        data: List[types.RecordCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.RecordWhereUniqueInput,
        include: Optional[types.RecordInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.RecordUpdateManyMutationInput,
        where: types.RecordWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Record,
    ...
    def delete_many(
        self,
        where: Optional[types.RecordWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Record,
