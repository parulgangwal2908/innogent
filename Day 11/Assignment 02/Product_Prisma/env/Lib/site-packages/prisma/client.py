...
SCHEMA_PATH = Path('C:/Users/Dell/Desktop/Product_Prisma/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:../app/data.db', 'fromEnvVar': None}).resolve(),
            'source_file_path': 'C:/Users/Dell/Desktop/Product_Prisma/prisma/schema.prisma',
        }
